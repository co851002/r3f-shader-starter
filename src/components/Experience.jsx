...
import vert from "../shaders/fire.vert";
import frag from "../shaders/fire.frag";
...
// New component to render a simple cube
const Cube = () => {
  return (
    <mesh position={[0.7, 0.9, 0]}>
      {/* Position the cube to the side so it doesn't overlap with the fire effect */}
      <boxGeometry args={[0.2, 0.2, 0.2]} /> {/* Cube geometry */}
      <meshStandardMaterial color="royalblue" /> {/* Simple material */}
    </mesh>
  );
};
